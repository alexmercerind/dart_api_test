...
import 'dart_api_test_bindings_generated.dart';
...
const String _libName = 'dart_api_test';

/// The dynamic library in which the symbols for [DartApiTestBindings] can be found.
...
final DartApiTestBindings _bindings = DartApiTestBindings(_dylib);
